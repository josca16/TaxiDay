    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <div className="bg-red-900/80 text-red-100 p-8 rounded-xl shadow-xl text-center max-w-md border border-red-800">
          ...
          <p className="mb-6 text-red-200">No hay turno activo o el ID de turno es inválido.</p>
          <button
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <div className="bg-surface/90 text-red-500 p-8 rounded-xl shadow-xl text-center max-w-md">
          ...
          <p className="mb-6">Usuario no autenticado. Por favor, inicie sesión.</p>
          <button
            onClick={() => navigate('/')}
            className="w-full bg-primary hover:bg-primary-dark text-gray-900 font-semibold py-3 px-6 rounded-lg transition-colors shadow-md"
          >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-primary/10 flex flex-col">
      ...
      <div className="flex-1 container mx-auto px-6 py-8">
        ...
        {turnoInfo && (
          <div className="mb-6 bg-surface/70 backdrop-blur-sm p-6 rounded-xl border border-border shadow-lg">
            ...
            <div className="mt-5 pt-5 border-t border-border">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-lg font-semibold">Notas del Turno</h3>
              ...
              {editandoNotas ? (
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="bg-primary hover:bg-primary-dark text-gray-900 font-medium px-4 py-2 rounded-lg transition-colors shadow-sm mt-2"
                  >
                ...
                <div className="bg-background/30 rounded-lg p-4 border border-border/50">
                  {turnoInfo && turnoInfo.notas ? (
                    <p className="whitespace-pre-wrap">{turnoInfo.notas}</p>
                  ) : (
                    <p className="text-text-muted text-sm italic">No hay notas para este turno</p>
                  )}
                </div>
              )}
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-8">
          ...
          <div>
            ...
            <input
              ...
              value={carreraData.precioTaximetro}
                        ...
                        className="w-full px-4 py-2 bg-background border border-border rounded-lg focus:ring-2 focus:ring-primary text-text"
                        placeholder="Introduce el precio del taxímetro"
            />
          </div>
          ...
          <div className="flex gap-6 mt-2">
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 text-primary bg-background border-border rounded focus:ring-primary mr-2"
              />
              <label htmlFor="esAeropuerto" className="flex items-center text-sm font-medium text-text">
            ...
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 text-primary bg-background border-border rounded focus:ring-primary mr-2"
              />
              <label htmlFor="esEmisora" className="flex items-center text-sm font-medium text-text">
                <svg className="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            ...
            />
                    ...
                    <div>
                      <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-primary hover:bg-primary-dark text-gray-900 font-medium py-2.5 rounded-lg transition-colors shadow-md"
                      >
                        {loading ? (
                          <span className="flex items-center justify-center">
                            <span className="animate-spin rounded-full h-4 w-4 mr-2 border-b-2 border-gray-900"></span>
                            Guardando...
                          </span>
                        ) : 'Guardar Carrera'}
                      </button>
            ...
            {/* Estadísticas */}
            <div className="mt-6 bg-surface/70 backdrop-blur-sm rounded-xl border border-border shadow-lg overflow-hidden">
              <div className="px-6 py-5 border-b border-border">
              ...
              <div className="p-6">
                {loadingCarreras ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-text-muted mb-6">Registra tus carreras en el formulario de la izquierda.</p>
            </div>
          )}
              </div>
            </div>
